...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    appVersatilisAuthUserSubject.add(
      AppVersatilisAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<AppVersatilisAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  AppVersatilisAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = AppVersatilisAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    appVersatilisAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
AppVersatilisAuthUser? currentUser;

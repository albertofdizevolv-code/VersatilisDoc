...
class _RegisterWidgetState extends State<RegisterWidget> {
  ...
  void initState() {
    ...
    _model.textFieldTeleMask = MaskTextInputFormatter(mask: '(##) ####-####');
    ...
    _model.textFieldDataNascTextController ??= TextEditingController();
    _model.textFieldDataNascFocusNode ??= FocusNode();

    _model.textFieldDataNascMask = MaskTextInputFormatter(mask: '##/##/####');
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(40.0, 0.0, 0.0, 45.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                  children: [
                    Column(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: TextFormField(
                                            controller: _model
                                                .textFieldDataNascTextController,
                                            focusNode: _model
                                                .textFieldDataNascFocusNode,
                                            autofocus: false,
                                            obscureText: false,
                                            decoration: InputDecoration(
                                              isDense: true,
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (_model.outForm!) {
                                  ...
                                  _shouldSetState = true;
                                  FFAppState().token = RefreshTokenCall.token(
                                    (_model.outAuth?.jsonBody ?? ''),
                                  )!;
                                  safeSetState(() {});
                                  _model.cadastroUsuarioR =
                                    ...
                                    dtNascimento: _model
                                        .textFieldDataNascTextController.text,
                                  ...
                                  _shouldSetState = true;
                                  if ((_model.cadastroUsuarioR?.succeeded ??
                                      true)) {
                                    await showDialog(
                                      context: context,
                                      builder: (alertDialogContext) {
                                        return WebViewAware(
                                          child: AlertDialog(
                                            ...
                                            content: Text(
                                                'Bem Vindo! ${DizinvolveClientApiGroup.cadastrarUsuarioSimplesCall.nome(
                                              (_model.cadastroUsuarioR
                                                      ?.jsonBody ??
                                                  ''),

...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.passMedicoTextController ??= TextEditingController();
    _model.passMedicoFocusNode ??= FocusNode();
  }
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(40.0, 16.0, 0.0, 45.0),
                child: Row(
                      ...
                      children: [
                        Align(
                          ...
                          child: TabBar(
                            ...
                            indicatorColor: FlutterFlowTheme.of(context).black,
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            ...
                                            _model.userLogin =
                                              ...
                                              token: RefreshTokenCall.token(
                                                (_model.outAuth?.jsonBody ??
                                                    ''),
                                              ),
                                            );
                                            ...
                                            if ((_model.userLogin?.succeeded ??
                                              ...
                                              await authManager.signIn(
                                                authenticationToken:
                                                    RefreshTokenCall.token(
                                                  (_model.outAuth?.jsonBody ??
                                                      ''),
                                                ),
                                                tokenExpiration:
                                                    functions.customExpires(
                                                        RefreshTokenCall
                                                            .expires(
                                                  (_model.outAuth?.jsonBody ??
                                                      ''),
                                                )!),
                                                authUid: UserDataStruct
                                                        .maybeFromMap((_model
                                                                .userLogin
                                                                ?.jsonBody ??
                                                            ''))
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      Container(
                                                        ...
                                                        child: Image.asset(
                                                          'assets/images/2021_Facebook_icon_1.png',
                                                          fit: BoxFit.cover,
                                                        ),
                                                      ),
                                                      Text(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                  .passMedicoTextController,
                                              focusNode:
                                                  _model.passMedicoFocusNode,
                                              autofocus: false,
                                              obscureText:
                                                  !_model.passMedicoVisibility,
                                              decoration: InputDecoration(
                                                isDense: true,
                                                labelStyle:
                                                    FlutterFlowTheme.of(context)
                                              ...
                                              cursorColor:
                                                  FlutterFlowTheme.of(context)
                                                      .primaryText,
                                              validator: _model
                                                  .passMedicoTextControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ].divide(SizedBox(height: 8.0)),
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            _model.outAuthMedico =
                                                await RefreshTokenCall.call();

                                            _model.outMedico =
                                                await DizinvolveAuthAndCreateGroup
                                                    .loginMedicoCall
                                                    .call(
                                              login: _model
                                                  .emailLoginTextController
                                            ...
                                            if ((_model.outMedico?.succeeded ??
                                                true)) {
                                              GoRouter.of(context)
                                                  .prepareAuthEvent();
                                              await authManager.signIn(
                                                authenticationToken:
                                                    MedicoStruct.maybeFromMap(
                                                            (_model.outMedico
                                                                    ?.jsonBody ??
                                                                ''))
                                                        ?.token,
                                                authUid: MedicoStruct
                                                        .maybeFromMap((_model
                                                                .outMedico
                                                                ?.jsonBody ??
                                                            ''))

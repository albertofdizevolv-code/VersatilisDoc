...
class ForgetPassWidget extends StatefulWidget {
  ...
  static String routePath = '/forgetPass';
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(40.0, 0.0, 40.0, 45.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  'Não se preocupe, isso acontece! Insira aqui o seu e-mail, por favor.',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        font: GoogleFonts.inter(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  validator: _model
                                      ...
                                      .asValidator(context),
                                  inputFormatters: [_model.textFielddataMask],
                                ),
                              ].divide(SizedBox(height: 6.0)),
                            ),
                            FFButtonWidget(
                              onPressed: () async {
                                _model.apiResultkym =
                                  ...
                                  data: functions.parseToIsoOrZero(
                                      _model.textFielddataTextController.text),
                                  cpf: _model.textFieldcpfTextController.text,
                                );

                                if ((_model.apiResultkym?.succeeded ?? true)) {
                                  await launchURL(DizinvolveAuthAndCreateGroup
                                      .linkNovaSenhaCall
                                      .link(
                                    (_model.apiResultkym?.jsonBody ?? ''),
                                  )!);
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return WebViewAware(
                                        child: AlertDialog(
                                          title: Text('Erro dados invalidos'),
                                          content: Text(
                                              (_model.apiResultkym?.jsonBody ??
                                                      '')
                                                  .toString()),

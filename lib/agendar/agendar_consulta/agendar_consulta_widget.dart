...
import 'agendar_consulta_model.dart';
export 'agendar_consulta_model.dart';

class AgendarConsultaWidget extends StatefulWidget {
  const AgendarConsultaWidget({
    super.key,
    required this.nomeMedico,
    required this.especialidade,
    required this.unidadde,
  ...
  static String routeName = 'AgendarConsulta';
  static String routePath = '/agendarConsulta';

  @override
  State<AgendarConsultaWidget> createState() => _AgendarConsultaWidgetState();
}

class _AgendarConsultaWidgetState extends State<AgendarConsultaWidget> {
  late AgendarConsultaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgendarConsultaModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResult8xp =
          await DizinvolveClientApiGroup.precosPorColaboradorCall.call(
        codColaborador: widget.codColaborador,
        token: FFAppState().token,
      );

      _model.procedimento = ((_model.apiResult8xp?.jsonBody ?? '')
              .toList()
              .map<ProcoColaboradorStruct?>(ProcoColaboradorStruct.maybeFromMap)
              .toList() as Iterable<ProcoColaboradorStruct?>)
          .withoutNulls
          .where((e) => e.codProcedimento == widget.codProcedimento)
          .toList()
          .toList()
          .cast<ProcoColaboradorStruct>();
      safeSetState(() {});
      _model.horarioColaboradorPage =
          await DizinvolveClientApiGroup.listarHorarioDoColaboradorCall.call(
        codigo: widget.codColaborador,
        token: FFAppState().token,
      );

      if ((_model.horarioColaboradorPage?.succeeded ?? true)) {
        _model.horaColaborador = ((_model.horarioColaboradorPage?.jsonBody ??
                    '')
                .toList()
    ...
    _model.textFieldCepTextController ??=
        TextEditingController(text: functions.formatCPF(FFAppState().User.cpf));
    _model.textFieldCepFocusNode ??= FocusNode();

    _model.textFieldCepMask = MaskTextInputFormatter(mask: '###.###.###-##');
    _model.textFieldFoneTextController ??=
        TextEditingController(text: FFAppState().User.celular);
    _model.textFieldFoneFocusNode ??= FocusNode();

    _model.textFieldFoneMask = MaskTextInputFormatter(mask: '#######-####');
    _model.textFieldDateTextController ??= TextEditingController(
        text: functions.converterDataPadrao(widget.data!));
    _model.textFieldDateFocusNode ??= FocusNode();

    _model.textFieldDateMask = MaskTextInputFormatter(mask: '##.##.####');
    _model.textFieldUnidadeTextController ??=
        TextEditingController(text: widget.unidadde);
    _model.textFieldUnidadeFocusNode ??= FocusNode();

    _model.textFieldprecoTextController ??= TextEditingController();
    _model.textFieldprecoFocusNode ??= FocusNode();

    _model.textFieldprecoMask = MaskTextInputFormatter(mask: '###.###.###-##');
  }
                ...
                child: Column(
                  ...
                  children: [
                                  ...
                                  children: [
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .textFieldFoneTextController,
                                          focusNode:
                                              _model.textFieldFoneFocusNode,
                                          autofocus: false,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            isDense: true,
                                  ...
                                  children: [
                                    Expanded(
                                      child: FlutterFlowDropDown<int>(
                                        controller: _model
                                                .dropDownHorarioValueController ??=
                                            FormFieldController<int>(
                                          _model.dropDownHorarioValue ??= 0,
                                        ),
                                        options: List<int>.from(_model
                                            .horaColaborador
                                            .map((e) => e.codHorario)
                                            .toList()),
                                        optionLabels: _model.horaColaborador
                                            .map((e) => e.hora)
                                            .toList(),
                                        onChanged: (val) => safeSetState(() =>
                                            _model.dropDownHorarioValue = val),
                                        width: 200.0,
                                        height: 40.0,
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.textFieldUnidadeTextController,
                                    focusNode: _model.textFieldUnidadeFocusNode,
                                    autofocus: false,
                                    readOnly: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                    ...
                    FutureBuilder<ApiCallResponse>(
                      future: DizinvolveClientApiGroup.convenioUsuarioAtivoCall
                          .call(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                ' Informe o nome do seu plano de saúde:',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.inter(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: FlutterFlowDropDown<int>(
                                          controller: _model
                                                  .dropDownplanoValueController ??=
                                              FormFieldController<int>(
                                            _model.dropDownplanoValue ??= 1,
                                          ),
                                          ...
                                          onChanged: (val) async {
                                            ...
                                            safeSetState(() {
                                              _model
                                                  ...
                                                  ?.text = formatNumber(
                                                DizinvolveClientApiGroup
                                                    .precoDaConsultaMedicoGeralCall
                                                    .preco(
                                                  (_model.outPlano?.jsonBody ??
                                                      ''),
                                                ),
                                            ...
                                            _model.convenio = _model
                                                ...
                                                .firstOrNull
                                                ?.convenio;
                                            _model.valor = DizinvolveClientApiGroup
                                                .precoDaConsultaMedicoGeralCall
                                                .preco(
                                              (_model.outPlano?.jsonBody ?? ''),
                                            );
                              ...
                              Text(
                                'Observação: Apresente sua carteirinha no dia da consulta. O atendimento está sujeito à cobertura do plano.',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.inter(
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (confirmDialogResponse) {
                              ...
                              if (_model.dropDownHorarioValue == null) {
                                _model.outForm = false;
                              }
                              ...
                              if (_model.outForm!) {
                                _model.apiResult45h =
                                    await DizinvolveClientApiGroup
                                        .marcarAgendamentoCall
                                        .call(
                                  codUnidade: widget.codUnidade,
                                  codEspecialidade: widget.codEspecialidade,
                                  codPlano: _model.dropDownplanoValue,
                                  codHorario: _model.dropDownHorarioValue,
                                  data: widget.data,
                                  codUsuario: FFAppState().User.codUsuario,
                                  codColaborador: widget.codColaborador,
                                ...
                                _shouldSetState = true;
                                if ((_model.apiResult45h?.succeeded ?? true)) {
                                  context.pushNamed(
                                    AgendamentoSucessoWidget.routeName,
                                    queryParameters: {
                                      'cdVenda': serializeParam(
                                        DizinvolveClientApiGroup
                                            .marcarAgendamentoCall
                                            .codAgendamento(
                                          (_model.apiResult45h?.jsonBody ?? ''),
                                        ),
                                        ParamType.int,
                                      ),
                                    ...
                                    builder: (alertDialogContext) {
                                      return WebViewAware(
                                        child: AlertDialog(
                                          ...
                                          content: Text(
                                              'Confirmar a seleção dos itens antes de continuar'),
                                          actions: [
                                            TextButton(
                                              onPressed: () => Navigator.pop(
                                                  alertDialogContext),

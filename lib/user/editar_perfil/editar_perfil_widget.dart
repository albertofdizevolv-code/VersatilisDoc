  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.textController5?.text = dateTimeFormat(
            "d/M/y",
            functions.stringToDateTime(FFAppState().User.dtNasc),
                      ...
                      children: [
                        ...
                        if (responsiveVisibility(
                          ...
                          Row(
                            ...
                            children: [
                              wrapWithModel(
                                model: _model.fotoSelectModel,
                                updateCallback: () => safeSetState(() {}),
                                child: FotoSelectWidget(
                                  imaage: 'https://picsum.photos/seed/768/600',
                                ),
                              ),
                            ],
                          ),
                          ...
                          onPressed: () async {
                            if (_model.textController6.text ==
                              ...
                              _model.apiResult578 =
                                ...
                                senha: _model.textController6.text,
                                dataNasc: functions.parseToIsoOrZero(
                                    _model.textController5.text),
                                token: FFAppState().token,
                              );

                              if ((_model.apiResult578?.succeeded ?? true)) {
                                await showDialog(
                                  context: context,
                                ...
                                FFAppState().updateUserStruct(
                                  (e) => e
                                    ..nome = DizinvolveClientApiGroup
                                        .atualizarUsuarioCall
                                        .nome(
                                      (_model.apiResult578?.jsonBody ?? ''),
                                    )
                                    ..cpf = DizinvolveClientApiGroup
                                        .atualizarUsuarioCall
                                        .cpf(
                                      (_model.apiResult578?.jsonBody ?? ''),
                                    )
                                    ..email = DizinvolveClientApiGroup
                                        .atualizarUsuarioCall
                                        .email(
                                      (_model.apiResult578?.jsonBody ?? ''),
                                    )
                                    ..senha = DizinvolveClientApiGroup
                                        .atualizarUsuarioCall
                                        .senha(
                                      (_model.apiResult578?.jsonBody ?? ''),
                                    )
                                    ..dtNasc = DizinvolveClientApiGroup
                                        .atualizarUsuarioCall
                                        .dataNasc(
                                      (_model.apiResult578?.jsonBody ?? ''),
                                    )
                                    ..telefone = DizinvolveClientApiGroup
                                        .atualizarUsuarioCall
                                        .celular(
                                      (_model.apiResult578?.jsonBody ?? ''),
                                    )
                                    ..celular = DizinvolveClientApiGroup
                                        .atualizarUsuarioCall
                                        .celular(
                                      (_model.apiResult578?.jsonBody ?? ''),
                                    ),

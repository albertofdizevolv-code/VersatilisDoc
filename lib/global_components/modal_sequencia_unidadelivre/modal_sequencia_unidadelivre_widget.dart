...
import 'modal_sequencia_unidadelivre_model.dart';
export 'modal_sequencia_unidadelivre_model.dart';

class ModalSequenciaUnidadelivreWidget extends StatefulWidget {
  const ModalSequenciaUnidadelivreWidget({super.key});

  @override
  State<ModalSequenciaUnidadelivreWidget> createState() =>
      _ModalSequenciaUnidadelivreWidgetState();
}

class _ModalSequenciaUnidadelivreWidgetState
    extends State<ModalSequenciaUnidadelivreWidget> {
  late ModalSequenciaUnidadelivreModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalSequenciaUnidadelivreModel());
  }
                        ...
                        Container(
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final listViewTodasUnidadesDisponiveisResponse =
                                  snapshot.data!;

                              return Builder(
                                builder: (context) {
                                  final listaUnidades =
                                      (listViewTodasUnidadesDisponiveisResponse
                                                      .jsonBody
                                                      .toList()
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemBuilder: (context, listaUnidadesIndex) {
                                      ...
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          _model.unidade =
                                              listaUnidadesItem.codUnidade;
                                          _model.nomeUnidade =
                                              listaUnidadesItem.nomeUnidade;
                                          safeSetState(() {});
                                        },
                                        child: Container(
                                          decoration: BoxDecoration(

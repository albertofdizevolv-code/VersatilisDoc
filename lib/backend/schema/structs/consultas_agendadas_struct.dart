...
class ConsultasAgendadasStruct extends BaseStruct {
  ConsultasAgendadasStruct({
  ...
  static ConsultasAgendadasStruct fromMap(Map<String, dynamic> data) =>
      ConsultasAgendadasStruct(
  ...
  static ConsultasAgendadasStruct? maybeFromMap(dynamic data) => data is Map
      ? ConsultasAgendadasStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static ConsultasAgendadasStruct fromSerializableMap(
  ...
  @override
  String toString() => 'ConsultasAgendadasStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is ConsultasAgendadasStruct &&
...
ConsultasAgendadasStruct createConsultasAgendadasStruct({
  String? especialidade,
  String? procedimento,
  String? unidade,
  String? medico,

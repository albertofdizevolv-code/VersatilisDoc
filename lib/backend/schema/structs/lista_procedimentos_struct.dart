...
class ListaProcedimentosStruct extends BaseStruct {
  ...
  static ListaProcedimentosStruct fromMap(Map<String, dynamic> data) =>
      ListaProcedimentosStruct(
  ...
  static ListaProcedimentosStruct? maybeFromMap(dynamic data) => data is Map
      ? ListaProcedimentosStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static ListaProcedimentosStruct fromSerializableMap(
  ...
  @override
  String toString() => 'ListaProcedimentosStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is ListaProcedimentosStruct &&
...
ListaProcedimentosStruct createListaProcedimentosStruct({
  int? codProcedimento,
  String? nomeProcedimento,
  int? codEspecialidade,
  String? nomeEspecialidade,

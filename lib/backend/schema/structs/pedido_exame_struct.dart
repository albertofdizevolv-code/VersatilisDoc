...
class PedidoExameStruct extends BaseStruct {
  PedidoExameStruct({
  ...
  static PedidoExameStruct fromMap(Map<String, dynamic> data) =>
      PedidoExameStruct(
  ...
  static PedidoExameStruct? maybeFromMap(dynamic data) => data is Map
      ? PedidoExameStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static PedidoExameStruct fromSerializableMap(Map<String, dynamic> data) =>
      PedidoExameStruct(
  ...
  @override
  String toString() => 'PedidoExameStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is PedidoExameStruct &&
...
PedidoExameStruct createPedidoExameStruct({
  int? codModeloReceituario,
  String? nome,
  String? template,
}) =>

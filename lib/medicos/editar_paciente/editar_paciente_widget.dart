                                ...
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.textFieldTelTextController,
                                      focusNode: _model.textFieldTelFocusNode,
                                      autofocus: false,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        isDense: true,
                                ...
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.textFieldEndeTextController,
                                      focusNode: _model.textFieldEndeFocusNode,
                                      autofocus: false,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        isDense: true,
                                      ...
                                      cursorColor: FlutterFlowTheme.of(context)
                                          .primaryText,
                                      validator: _model
                                          .textFieldEndeTextControllerValidator
                                          .asValidator(context),
                                    ),
                                  ),
                                ),
                                ...
                                Expanded(
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      if (_model.outForm!) {
                                        _model.updaUsuario =
                                            await DizinvolveClientApiGroup
                                                .alterarUsuarioCall
                                                .call(
                                          nome: _model
                                          ...
                                          email: _model
                                              ...
                                              .text,
                                          dtNascimento: functions
                                              .converterDataPadrao(_model
                                                  .textFieldDataTextController
                                                  .text),
                                          sexo: _model.dropDownSexoValue,
                                          telefone: _model
                                              .textFieldTelTextController.text,
                                          celular: _model
                                              .textFieldTelTextController.text,
                                          bairro: _model
                                              .textFieldBairroTextController
                                          ...
                                          complemento: _model
                                              ...
                                              .text,
                                          endereco: _model
                                              .textFieldEndeTextController.text,
                                          cep: _model
                                        ...
                                        _shouldSetState = true;
                                        if ((_model.updaUsuario?.succeeded ??
                                            true)) {
                                          await showDialog(
                                            context: context,
                                              ...
                                              return WebViewAware(
                                                child: AlertDialog(
                                                  title:
                                                      Text('Cadastro Feito!'),
                                                  content: Text(
                                                      'Cadastro do paciente ${_model.textFieldNomeTextController.text} Efetuado com sucesso!'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(

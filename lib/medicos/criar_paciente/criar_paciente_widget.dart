...
import 'criar_paciente_model.dart';
export 'criar_paciente_model.dart';

class CriarPacienteWidget extends StatefulWidget {
  const CriarPacienteWidget({super.key});

  static String routeName = 'CriarPaciente';
  static String routePath = '/criarPaciente';

  @override
  State<CriarPacienteWidget> createState() => _CriarPacienteWidgetState();
}

class _CriarPacienteWidgetState extends State<CriarPacienteWidget> {
  late CriarPacienteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CriarPacienteModel());
    ...
    _model.textFieldEndeTextController ??= TextEditingController();
              ...
              child: Column(
                ...
                children: [
                  wrapWithModel(
                    ...
                    child: HeaderWidget(
                      title: 'Formulário de novo paciente',
                    ),
                  ),
                  Container(
                                              ...
                                              return WebViewAware(
                                                child: AlertDialog(
                                                  title:
                                                      Text('Cadastro Feito!'),
                                                  content: Text(
                                                      'Cadastro do paciente ${DizinvolveClientApiGroup.cadastrarUsuarioSimplesCall.nome(
                                                    (_model.cadastroUsuario
                                                            ?.jsonBody ??
                                                        ''),

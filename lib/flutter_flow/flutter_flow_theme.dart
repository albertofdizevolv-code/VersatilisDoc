...
abstract class FlutterFlowTheme {
  ...
  late Color blackVersatilis;
  late Color black;
  late Color textTitle;
  late Color customBlue;
  late Color textBlue;
  late Color redVersatilis;
  late Color greyButton;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0D0D1B);
  late Color secondary = const Color(0xFF1F2A37);
  ...
  late Color blackVersatilis = const Color(0xFF0D0D1B);
  late Color black = const Color(0xFF000000);
  late Color textTitle = const Color(0xFF1F2A37);
  late Color customBlue = const Color(0xFF4D33D6);
  late Color textBlue = const Color(0xFF222B45);
  late Color redVersatilis = const Color(0xFFE82626);
  late Color greyButton = const Color(0xFF626465);
  late Color textWhite = const Color(0xFFEEEEEE);
  late Color customColor = const Color(0xFFFFA366);
  late Color lightGray = const Color(0xFF8F9BB3);
}
